            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    <div class="form-group mt-1">
                        ...
                        <a href="{{ route('history-member.print') }}?daterange={{ request('daterange') }}" class="btn btn-info mt-3"><i class="fas fa-print me-1"></i>Print</a>
                        <a href="{{ route('history-member.export') }}?daterange={{ request('daterange') }}" class="btn btn-success mt-3"><i class="fas fa-file-excel me-1"></i>Download</a>
                    </div>
                </div>
            </div>
        </form>
            ...
            <table id="datatable" class="table table-striped table-bordered align-middle w-100">
                <thead>
                    <tr>
                        ...
                        <th class="text-nowrap">Scanned At</th>
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        responsive: true,
        ajax: {
            url: "{{ route('history-transactions.list') }}",
            type: "GET",
            data: {
                "daterange": daterange,
                "status": $('#status').val()
